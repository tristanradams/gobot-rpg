...
using RpgCSharp.scripts.characters.enemies;
...
public partial class EventBus : Node
{
    // Game state signals
    [Signal]
    public delegate void GameStateChangedEventHandler(GameManager.GameState newState);
    ...
    // Combat signals
    [Signal]
    public delegate void DamageDealtEventHandler(FightingCharacter target, int amount, FightingCharacter source);
    ...
    [Signal]
    public delegate void DialogueChoiceMadeEventHandler(int choiceIndex);
    ...
    [Signal]
    public delegate void QuestUpdatedEventHandler(string questId);
    ...
    // UI signals
    [Signal]
    public delegate void NotificationRequestedEventHandler(string message);
}